...
import BoxAdsApp from "../../../listsPages/DropdownContent/_BoxAdsApp";
...
export function ServicesSection() {
  ...
  return (
    <div className='col-span-2 rounded-lg  relative'>
      <div className='h-[calc(100%-80px)] flex justify-between items-start bg-gray-100'>
        <Services />
        <div className="text-dis w-1/2 h-56 rounded-br-lg rounded-tl-lg bg-white absolute rtl:left-0 ltr:right-0 top-0 flex justify-end">
          <div className='w-3 h-3 absolute -bottom-[1px]  -right-[1px] '>
            <svg className='w-full h-full' width="7" height="7" viewBox="0 0 7 7" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <BoxAdsApp/>
          <div className='bg-gray-100 p-2 rounded-tl-lg w-full h-[calc(100%-80px)] absolute top-[calc(100%)] flex justify-between gap-2'>
            <div className="w-1/2">
