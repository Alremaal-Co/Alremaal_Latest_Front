...
"use client"
import LinksPupNavbar from './linksPup.navbar-v2'
import IconsNavbarV2 from './Icons.navbat-v2'
import { MAIN_DROPDOWN_NAVEBAR_V2_TYPE } from './_init/types';
import { dropdownVariantsNoOpacity, MAIN_DROPDOWN_NAVEBAR_V2 } from './_init';
    ...
    <div 
      ...
      <AnimatePresence>
        <MotionDiv
          ...
          className={`bg-accent  ${isHoverNavBar ? "block":"hidden"}  w-screen h-full fixed inset-0 top-[4rem] opacity-40 z-[100]`}
        ></MotionDiv>
...
export  function Cursor() {
  ...
  return (
    ...
    initial={{ left: 0 , width: 0 , opacity: 0}}
      ...
      className={`absolute bg-gray-200 h-10 w-10 rounded-full   p-2`}>
