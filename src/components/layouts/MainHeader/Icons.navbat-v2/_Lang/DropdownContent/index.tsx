...
export default function DropdownContent() {
  ...
  return (
    <MainDropdown stateValue={NAVBAR_STATE_TYPE.LANG}>
      <div onClick={(e: React.MouseEvent<HTMLDivElement, MouseEvent>)=>onClick(e , false)} className="absolute bg-gray-100 rounded-b-[20px] -top-0 ltr:right-[10vw] h-auto rtl:left-[1vw] w-[35vw] bg-white shadow-lg">
        <DropdownArrow/>
