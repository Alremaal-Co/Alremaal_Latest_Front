...
// import { TableManagerApiModule } from "@/lib/api/TableManagerApi";
...
//   const serverApi = createServerApi(serverApiClient, TableManagerApiModule);

//   // Pre-fetch the first page of data on the server before rendering.
//   await serverApi.prefetch("list", { page: 1, limit: 100 }, { 
...
//       <RealEstateOffersClient hydratedState={dehydratedState} />
//     </main>
//   );
// }